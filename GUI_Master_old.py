...
root.title("Deep Learning Approaches On Polycystic Ovary Syndrome")
...
#
lbl = tk.Label(root, text="Image Data Input ", font=('times', 35,' bold '), height=1, width=60,bg="maroon",fg="white")
lbl.place(x=0, y=3)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='C:/Users/sejal/Desktop/PCOS_code1/test_set',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
#     global fn
#     fileName = askopenfilename(initialdir='F:/2023 project code/Machine Learning Approaches on Polycystic Ovary Syndrome/PCOS 100% Code/test_set',
#                                filetypes=[("all files", "*.*")])
#     IMAGE_SIZE=200
#     imgpath = fileName
#     fn = fileName
